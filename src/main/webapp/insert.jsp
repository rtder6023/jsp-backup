...
<%
	...
	String sql = " SELECT TRIM(MAX(custno)+1) AS custno " +
				 " FROM member_tbl_02 ";
...
<form name="frm" action="action.jsp">
	<table border="1">
		...
		<tr>
			<th>회원성명</th>
			<td align="left">
				<input style="width: 100px" name='custname' id='custname' value='' >
			</td>
		</tr>
		<tr>
			<th>회원전화</th>
		...
		<tr>
			<th>회원주소</th>
			<td align="left">
				<input style="width: 250px" name='address' id='address' value=''>
			</td>
		</tr>
		<tr>
			<th>가입일자</th>
			<td align="left">
				<input style="width: 100px" name='joindate' id='joindate' value=''>
			</td>
		</tr>
		<tr>
			<th>고객등급 [A:VIP,B:일반,C:직원]</th>
			<td align="left">
				<input style="width: 100px" name='grade' id='grade' value=''>
			</td>
		</tr>
		<tr>
			<th>도시코드</th>
			<td align="left">
				<input style="width: 100px" name='city' id='city' value=''>
			</td>
		</tr>
		<tr>
			<td colspan=2>
